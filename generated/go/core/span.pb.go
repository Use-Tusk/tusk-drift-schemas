...
type Span struct {
	...
	InputSchema  *structpb.Struct `protobuf:"bytes,11,opt,name=input_schema,json=inputSchema,proto3" json:"input_schema,omitempty"`    // Schema definition for input
	OutputSchema *structpb.Struct `protobuf:"bytes,12,opt,name=output_schema,json=outputSchema,proto3" json:"output_schema,omitempty"` // Schema definition for output
...
func (x *Span) GetInputSchema() *structpb.Struct {
	if x != nil {
...
func (x *Span) GetOutputSchema() *structpb.Struct {
	if x != nil {
...
const file_core_span_proto_rawDesc = "" +
	"\n" +
	"\x0fcore/span.proto\x12\x12tusk.drift.core.v1\x1a\x1egoogle/protobuf/duration.proto\x1a\x1cgoogle/protobuf/struct.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xb0\b\n" +
	"\x04Span\x12\x19\n" +
	...
	"inputValue\x12:\n" +
	"\foutput_value\x18\n" +
	" \x01(\v2\x17.google.protobuf.StructR\voutputValue\x12:\n" +
	"\finput_schema\x18\v \x01(\v2\x17.google.protobuf.StructR\vinputSchema\x12<\n" +
	"\routput_schema\x18\f \x01(\v2\x17.google.protobuf.StructR\foutputSchema\x12*\n" +
...
var file_core_span_proto_depIdxs = []int32{
	...
	11, // 3: tusk.drift.core.v1.Span.input_schema:type_name -> google.protobuf.Struct
	11, // 4: tusk.drift.core.v1.Span.output_schema:type_name -> google.protobuf.Struct
	...
	12, // 7: tusk.drift.core.v1.Span.timestamp:type_name -> google.protobuf.Timestamp
	13, // 8: tusk.drift.core.v1.Span.duration:type_name -> google.protobuf.Duration
	...
	12, // 11: tusk.drift.core.v1.SpanEvent.timestamp:type_name -> google.protobuf.Timestamp
	...
	12, // 15: tusk.drift.core.v1.Trace.started_at:type_name -> google.protobuf.Timestamp
	12, // 16: tusk.drift.core.v1.Trace.completed_at:type_name -> google.protobuf.Timestamp
	10, // 17: tusk.drift.core.v1.Trace.metadata:type_name -> tusk.drift.core.v1.Trace.MetadataEntry
	14, // 18: tusk.drift.core.v1.SpanEvent.AttributesEntry.value:type_name -> google.protobuf.Value
	14, // 19: tusk.drift.core.v1.SpanLink.AttributesEntry.value:type_name -> google.protobuf.Value
