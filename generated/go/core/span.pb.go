...
type Span struct {
	...
	Environment   string `protobuf:"bytes,24,opt,name=environment,proto3" json:"environment,omitempty"` // Environment name (e.g., "production", "staging", "development")
...
const file_core_span_proto_rawDesc = "" +
	"\n" +
	"\x0fcore/span.proto\x12\x12tusk.drift.core.v1\x1a\x16core/json_schema.proto\x1a\x1egoogle/protobuf/duration.proto\x1a\x1cgoogle/protobuf/struct.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xe0\b\n" +
	"\x04Span\x12\x19\n" +
	...
	"\venvironment\x18\x18 \x01(\tR\venvironment\"Z\n" +
	"\n" +
	"SpanStatus\x122\n" +
